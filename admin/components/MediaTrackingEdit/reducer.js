import { FETCH_STUDY_MEDIA_TYPES_SUCCESS, DELETE_STUDY_MEDIA_TYPE_SUCCESS } from '../../containers/AdminStudyEdit/constants';
...
export default function mediaTrackingReducer(state = initialState, action) {
  switch (action.type) {
    case FETCH_STUDY_MEDIA_TYPES_SUCCESS:
      return {
        ...state,
        values: {
          ...state.values,
    ...
    case DELETE_STUDY_MEDIA_TYPE_SUCCESS:
      return {
        ...state,
        values: {
          ...state.values,
