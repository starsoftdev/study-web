...
class PatientText extends React.Component {
  ...
  renderProfileImage() {
    ...
    if (textMessage.user && textMessage.user.profileImageURL) {
      ...
      let url = require('../../../../app/assets/images/Default-User-Img-Dr.png');
      ...
      const url = require('../../../../app/assets/images/Default-User-Img-Girl.png');
      return (
        <img alt="" src={url} />
      );
    }
    const url = require('../../../../app/assets/images/Default-User-Img.png');
    return (
      <img alt="" src={url} />
    );
  }
