            ...
            <ul className="list-inline">
              ...
              <li>
                <span className="opener">
                  ...
                  <span className="text">ACTION<br /> NEEDED</span>
                </span>
              </li>
              <li>
                <span className="opener">
                                ...
                                <div className="catogery-list">
                                  <div className="catogery">
                                    <span className="bipolar-link">
                                      ...
                                      <a href="#" data-remove=".catogery" className="icon-icon_trash"></a>
                                    </span>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className="field-row full">
                              <div className="field add-indications">
                                <div className="indication-open-close">
                                  <a
                                    href="#"
                                    className="btn btn-primary select-indication-opener"
                                  >
                                    + Add Indication
                                  </a>
                                  ...
                                  <div className="row">
                                    <div className="col-small pull-left">
                                      ...
                                      >
                                        ...
                                        className="jcf-select jcf-unselectable jcf-select-min-width jcf-select-min-height"
                                      ><span
                                        className="jcf-select-text"
                                      ><span className="">Month</span></span><span
                                        className="jcf-select-opener"
                                      ></span></span>
                                    </div>
                                    <div className="col-small pull-left">
                                      <select data-required="true" className="min-height jcf-hidden">
                                        ...
                                        className="jcf-select jcf-unselectable jcf-select-min-height"
                                      ><span
                                        className="jcf-select-text"
                                      ><span className="">Day</span></span><span
                                        className="jcf-select-opener"
                                      ></span></span>
                                    </div>
                                    <div className="col-small pull-left patient-age">
                                      ...
                                      ><span
                                        className="jcf-select-text"
                                      ><span className="">Year</span></span><span
                                        className="jcf-select-opener"
                                      ></span></span>
                                    </div>
                                  </div>
                              ...
                              <div className="field-row">
                                ...
                                <div className="field patient-gender">
                                  <select id="patient-gender" data-required="true" className="jcf-hidden">
                                    ...
                                    className="jcf-select-text"
                                  ><span className="">Select Gender</span></span><span
                                    className="jcf-select-opener"
                                  ></span></span>
                                </div>
                              </div>
