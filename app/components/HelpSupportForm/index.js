...
import helpSupportFormValidator from './validator';

@reduxForm({ form: 'helpSupport', validate: helpSupportFormValidator })
class HelpSupportForm extends React.Component { // eslint-disable-line react/prefer-stateless-function
  static propTypes = {
