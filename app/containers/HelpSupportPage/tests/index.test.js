// import HelpSupportPage from '../index';
...
describe('HelpSupportPage/index component', () => {
  let setup;
  ...
  beforeEach(() => {
    setup = () => {
      ...
      const shallowWrapper = shallow(<HelpSupportPage {...props} />);
  ...
  it('should render the helpSupport form', () => {
    const { shallowWrapper } = setup();

    expect(shallowWrapper.contains(<ReduxForm />)).toEqual(true);
  });

  it('should pass correct props to the helpSupport form', () => {
