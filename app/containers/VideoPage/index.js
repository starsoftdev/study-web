...
import { selectCompanyTypes } from '../../containers/VideoPage/selectors';
import { submitForm, fetchCompanyTypes } from '../../containers/VideoPage/actions';
import {
  fetchClientSites,
    ...
    return (
      <div className="container-fluid">
        ...
        <section className="study-portal">
          ...
          <h2 className="main-heading">Video</h2>

          <div className="row form-study">
            <div className="video-info pull-right">
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    touchRefer: () => dispatch(touch('video', ...fields)),
  };
}
