        ...
        <table className="table-manage-user table">
          ...
          <thead>
            <tr>
              ...
              <th onClick={this.sortBy} data-sort="kiks" className={`th ${(this.props.paginationOptions.activeSort === 'kiks') ? this.props.paginationOptions.activeDirection : ''}`}>KIKS<i className="caret-arrow" /></th>
