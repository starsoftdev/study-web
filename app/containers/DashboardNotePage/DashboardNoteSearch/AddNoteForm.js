...
@reduxForm({ form: 'dashboardAddNoteForm', validate: formValidator })

export class AddNoteForm extends React.Component { // eslint-disable-line react/prefer-stateless-function
  static propTypes = {
      ...
      <form action="#" className="form-lightbox dashboard-lightbox" onSubmit={this.props.handleSubmit}>
        ...
        <div className="field-row">
          <strong className="label required">
            <label className="add-exposure-level">Note</label>
          </strong>
          <div className="field">
            <Field
              name="name"
