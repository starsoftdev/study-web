        ...
        <section className="reports">
          <div className="individual-study">
            <div className="main-head">
              ...
              <div>
                <div className="info-cell">{translate('sponsor.page.reportViewPage.indication')} {indication}</div>
                <div className="info-cell">{translate('sponsor.page.reportViewPage.cro')} {cro}</div>
              </div>
            </div>
          </div>
        </section>
