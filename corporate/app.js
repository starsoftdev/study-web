...
const routes = {
  ...
  childRoutes: [
    ...
    { path: '/br/:postalCode', component: Home },
    { path: '/ca/:postalCode', component: Home },
    { path: '/cz/:postalCode', component: Home },
    { path: '/de/:postalCode', component: Home },
    { path: '/fr/:postalCode', component: Home },
    { path: '/jp/:postalCode', component: Home },
    { path: '/it/:postalCode', component: Home },
    { path: '/pl/:postalCode', component: Home },
    { path: '/uk/:postalCode', component: Home },
    { path: '/:postalCode', component: Home },
