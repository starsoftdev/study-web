              ...
              <div className="patients-list-area">
                <nav className="nav-status">
                  <ul className="list-inline">
                    <li>
                      <span className="opener"><strong className="number">99</strong> <span
                        className="text">NEW PATIENT</span></span>
                      <div className="slide">
                        <div className="slide-holder">
                          <ul className="list-unstyled">
                            <li>
                              <a href="#" className="top" data-addclass="form-active"
                                 data-parentbox=".patients-list-area">
                                <strong className="name"><span className="first-name">Alan</span><br /> <span
                                  className="last-name">Jensen</span></strong>
                                <span className="email">alan_jensen@email.com</span>
                                <span className="phone" data-phone="5242999123456">(524) 999-123456</span>
                              </a>
                              <a href="#" className="bottom hidden" data-addclass="form-active"
                                 data-parentbox=".patients-list-area">
                    ...
                    <li>
                      <span className="opener"><strong className="number">0</strong> <span className="text">CALL<br /> ATTEMPTED</span></span>
                        ...
                        <div className="slide-holder">
                          <ul className="list-unstyled">
                            <li>
                              <a href="#" className="top" data-addclass="form-active"
                                 data-parentbox=".patients-list-area">
                                <strong className="name"><span className="first-name">Katy </span><br /> <span
                                  className="last-name">Perry</span></strong>
                    ...
                    <li>
                      <span className="opener"><strong className="number">0</strong> <span className="text">ACTION<br /> NEEDED</span></span>

                    </li>
                    <li>
                      <span className="opener"><strong className="number">1</strong> <span
                        className="text">SCHEDULED</span></span>
                      <div className="slide">
                        <div className="slide-holder">
                          <ul className="list-unstyled">
                            <li>
                              <a href="#" className="scheduled-patient-trigger top" data-addclass="form-active"
                                 data-parentbox=".patients-list-area" data-time="11:30 PM " data-date="05/08/16">
                                <strong className="name"><span className="first-name">Hamish  </span><br /> <span
                                  className="last-name">Labatt</span></strong>
                    ...
                    <li>
                      <span className="opener"><strong className="number">1</strong> <span
                        className="text">CONSENTED</span></span>
                      <div className="slide">
                        <div className="slide-holder">
                          <ul className="list-unstyled">
                            <li>
                              <a href="#" className="top" data-addclass="form-active"
                                 data-parentbox=".patients-list-area">
                                <strong className="name"><span className="first-name">Thomas   </span><br /> <span
                                  className="last-name">Morgan</span></strong>
                    ...
                    <li>
                      <span className="opener"><strong className="number">0</strong> <span className="text">SCREEN<br /> FAILED</span></span>
                    </li>
                    <li>
                      <span className="opener"><strong className="number">0</strong> <span
                        className="text">RANDOMIZED</span></span>
                    </li>
                  </ul>
                </nav>
                <div className="patients-list-form" data-formvalidationd="">
                  <div className="form-holder">
                    <div className="form-area">
                      <div className="form-head">
                        ...
                        <a href="#" data-addclass="form-active" data-parentbox=".patients-list-area"
                           data-classremove="form-active" className="btn-close"><i
                          className="glyphicon glyphicon-menu-right" /></a>
                      </div>
                          ...
                          <div className="field">
                            <div className="row">
                              <div className="col pull-left">
                                <input type="text" className="form-control" data-required="true"
                                       id="new-patient-first-name" placeholder="First Name" />
                              </div>
                              <div className="col pull-right">
                                <input type="text" className="form-control" data-required="true"
                                       id="new-patient-last-name" placeholder="last Name" />
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="column">
                        <div id="carousel-example-generic" className="carousel slide popup-slider" data-ride="carousel"
                             data-interval="false">
                          ...
                          <div className="carousel-inner" role="listbox">
                              ...
                              <section className="postarea notes">
                                <article className="post-msg">
                                  <div className="post-holder" data-post="1">
                                    <div className="img-holder"><img alt="image description" src="images/img2.png" />
                                    </div>
                                    <div className="post-content">
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt. Lorem ipsum dolor sit amet.</p>
                                      <a className="btn-trash" href="#" data-remove="[data-post=&quot;1&quot;]"><i
                                        className="icon-icon_trash" /></a>
                                  ...
                                  <div className="post-holder even" data-post="1-1">
                                    <div className="img-holder"><img alt="image description"
                                                                     src="images/img-logged-user.png" /></div>
                                    <div className="post-content">
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt.</p>
                                      <a className="btn-trash" href="#" data-remove="[data-post=&quot;1-1&quot;]"><i
                                        className="icon-icon_trash" /></a>
                                    </div>
                                ...
                                <article className="post-msg">
                                  <div className="post-holder" data-post="2">
                                    <div className="img-holder"><img alt="image description" src="images/img3.png" />
                                    </div>
                                    <div className="post-content">
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        ...
                                        sit amet.</p>
                                      <a className="btn-trash" href="#" data-remove="[data-post=&quot;2&quot;]"><i
                                        className="icon-icon_trash" /></a>
                                    </div>
                                  ...
                                  <div className="post-holder even" data-post="2-2">
                                    ...
                                    <div className="post-content">
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt.</p>
                                      <a className="btn-trash" href="#" data-remove="[data-post=&quot;2-2&quot;]"><i
                                        className="icon-icon_trash" /></a>
                                    </div>
                                    <strong className="email">Bruce Wayne</strong>
                                ...
                                <article className="post-msg">
                                  <div className="post-holder" data-post="3">
                                    ...
                                    <div className="post-content">
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt. Lorem ipsum dolor sit amet.</p>
                                      <a className="btn-trash" href="#" data-remove="[data-post=&quot;3&quot;]"><i
                                        className="icon-icon_trash" /></a>
                                    </div>
                                    <strong className="email">Alan Walker</strong>
                                  ...
                                  <div className="post-holder even" data-post="3-2">
                                    <div className="img-holder">
                                      <img alt="image description" src="images/img-logged-user.png" />
                                    </div>
                                    <div className="post-content">
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt.</p>
                                      <a className="btn-trash" href="#" data-remove="[data-post=&quot;3-2&quot;]"><i
                                        className="icon-icon_trash" /></a>
                                    </div>
                                    <strong className="email">Bruce Wayne</strong>
                                ...
                                <article className="post-msg">
                                  <div className="post-holder" data-post="4">
                                    ...
                                    <div className="post-content">
                                      <p>consectetur adipiscing elit, sed do eiusmod tempor incididunt. Lorem ipsum
                                        dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.
                                        Lorem ipsum dolor sit amet.</p>
                                      <a className="btn-trash" href="#" data-remove="[data-post=&quot;4&quot;]"><i
                                        className="icon-icon_trash" /></a>
                                    </div>
                                    <strong className="email">Penny Worth</strong>
                                  ...
                                  <div className="post-holder even" data-post="4-2">
                                    ...
                                    <div className="post-content">
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt.</p>
                                      <a className="btn-trash" href="#" data-remove="[data-post=&quot;4-2&quot;]"><i
                                        className="icon-icon_trash" /></a>
                                    </div>
                                    <strong className="email">Bruce Wayne</strong>
                              ...
                              <section className="postarea notes">
                                <article className="post-msg">
                                  <div className="post-holder patient" data-post="notes1">
                                    ...
                                    <div className="post-content">
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt. Lorem ipsum dolor sit amet.</p>
                                      <a className="btn-trash" href="#" data-remove="[data-post=&quot;notes1&quot;]"><i
                                        className="icon-icon_trash" /></a>
                                    </div>
                                  ...
                                  <div className="post-holder even" data-post="notes1-1">
                                    <div className="img-holder"><img alt="image description"
                                                                     src="images/Default-User-Img.png" /></div>
                                    <div className="post-content">
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt.</p>
                                      <a className="btn-trash" href="#"
                                         data-remove="[data-post=&quot;notes1-1&quot;]"><i className="icon-icon_trash" /></a>
                                    </div>
                                    <strong className="email">Bruce Wayne</strong>
                                    <time dateTime="2016-07-28">07/28/16 at 09:38 AM</time>
                                  </div>
                                ...
                                <article className="post-msg">
                                  <div className="post-holder patient" data-post="notes2">
                                    ...
                                    <div className="post-content">
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        ...
                                        consectetur adipiscing elit, sed do eiusmod tempor incididunt. Lorem ipsum dolor
                                        sit amet.</p>
                                      <a className="btn-trash" href="#" data-remove="[data-post=&quot;notes2&quot;]"><i
                                        className="icon-icon_trash" /></a>
                                    </div>
                                    <strong className="email patient-name">
                                      <span className="first-name">Alan</span>
                                  ...
                                  <div className="post-holder even" data-post="notes2-2">
                                    <div className="img-holder">
                                      <img alt="image description" src="images/Default-User-Img.png" />
                                    </div>
                                    <div className="post-content">
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt.</p>
                                      <a className="btn-trash" href="#"
                                         data-remove="[data-post=&quot;notes2-2&quot;]"><i className="icon-icon_trash" /></a>
                                    </div>
                                    <strong className="email">Bruce Wayne</strong>
                                    <time dateTime="2016-07-28">07/28/16 at 10:25 AM</time>
                                  </div>
                                ...
                                <article className="post-msg">
                                  <div className="post-holder patient" data-post="notes3">
                                    <div className="img-holder">
                                      <img alt="image description" src="images/img2.png" />
                                    </div>
                                    <div className="post-content">
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt. Lorem ipsum dolor sit amet.</p>
                                      <a className="btn-trash" href="#" data-remove="[data-post=&quot;notes3&quot;]"><i
                                        className="icon-icon_trash" /></a>
                                    </div>
                                    <strong className="email patient-name">
                                      <span className="first-name">Alan</span>
                                  ...
                                  <div className="post-holder even" data-post="notes3-2">
                                    ...
                                    <div className="post-content">
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt.</p>
                                      <a className="btn-trash" href="#"
                                         data-remove="[data-post=&quot;notes3-2&quot;]"><i className="icon-icon_trash" /></a>
                                    </div>
                                    <strong className="email">Bruce Wayne</strong>
                                    <time dateTime="2016-07-28">07/28/16 at 10:42 AM</time>
                                  </div>
                                  ...
                                  <div className="post-holder patient" data-post="notes4">
                                    ...
                                    <div className="post-content">
                                      <p>consectetur adipiscing elit, sed do eiusmod tempor incididunt. Lorem ipsum
                                        dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.
                                        Lorem ipsum dolor sit amet.</p>
                                      <a className="btn-trash" href="#" data-remove="[data-post=&quot;notes4&quot;]"><i
                                        className="icon-icon_trash" /></a>
                                    </div>
                                    <strong className="email patient-name">
                                      <span className="first-name">Alan</span>
                                  ...
                                  <div className="post-holder even" data-post="4-2">
                                    ...
                                    <div className="post-content">
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt.</p>
                                      <a className="btn-trash" href="#"
                                         data-remove="[data-post=&quot;notes4-2&quot;]"><i className="icon-icon_trash" /></a>
                                    </div>
                                    <strong className="email">Bruce Wayne</strong>
                                    <time dateTime="2016-07-28">07/28/16 at 10:56 AM</time>
                                  </div>
                            ...
                            <div className="item emails-info">
                              <section className="postarea">
                                <article className="post-email-alert">
                                  <a href="#" data-addclass="email-detail"
                                     data-parentbox=".post-email-alert, .emails-info">
                                    <div className="img-holder">
                                      <img src="images/img-logged-user.png" alt="image description" />
                                    </div>
                                  ...
                                  <div className="btn-block back-to-emails">
                                    <a href="#" className="btn btn-gray-outline" data-addclass="email-detail"
                                       data-parentbox=".post-email-alert, .emails-info" data-classremove="email-detail">back</a>
                                  </div>
                                </article>
                                <article className="post-email-alert">
                                  <a href="#" data-addclass="email-detail"
                                ...
                                <article className="post-email-alert">
                                  <a href="#" data-addclass="email-detail"
                                     data-parentbox=".post-email-alert, .emails-info">
                                    <div className="img-holder"><img src="images/img-logged-user.png"
                              ...
                              <div className="textarea">
                                <div className="btn-block text-right">
                                  <a href="#" className="btn btn-default" data-parentbox=".emails-info"
                                     data-addclass="parent-active">compose</a>
                                </div>
                              </div>
                              <div className="compose-email">
                                ...
                                <div className="textarea">
                                  <a href="#" className="btn btn-gray-outline pull-left" data-addclass="parent-active"
                                     data-parentbox=".emails-info" data-classremove="parent-active">back</a>
                            ...
                            <div className="item others">
                              <div className="item-holder">
                                ...
                                <form action="#" className="sub-holder form-lightbox" data-formvalidation=""
                                      ...
                                      <div className="catogery-list">
                                        <div className="catogery">
																				<span className="bipolar-link">
																					<span className="text">Bipolar</span> <a href="#" data-remove=".catogery"
                                                                                   className="icon-icon_trash"></a>
																				</span>
                                        </div>
                                      </div>
                                  ...
                                  <div className="field-row full">
                                    <div className="field add-indications">
                                      <div className="indication-open-close">
                                        <a href="#" className="btn btn-primary select-indication-opener">+ Add
                                          Indication</a>
                                          ...
                                          <div className="well custom-select-drop">
                                            <div className="search-holder">
                                              <input type="search" className="form-control keyword-search"
                                                     id="search10" />
                                              <label htmlFor="search10" className="icon-icon_search2"></label>
                                            </div>
                                  ...
                                  <div className="fields-holder">
                                      ...
                                      <div className="field">
                                        <div className="row">
                                          <div className="col-small pull-left">
                                            <select id="patient-dob" className="min-width min-height jcf-hidden"
                                                    data-required="true">
                                              <option>Month</option>
                                            ...
                                            className="jcf-select jcf-unselectable jcf-select-min-width jcf-select-min-height"><span
                                            className="jcf-select-text"><span className="">Month</span></span><span
                                          ...
                                          <div className="col-small pull-left">
                                            ...
                                            className="jcf-select jcf-unselectable jcf-select-min-height"><span
                                            className="jcf-select-text"><span className="">Day</span></span><span
                                            className="jcf-select-opener"></span></span>
                                          </div>
                                          <div className="col-small pull-left patient-age">
                                            ...
                                            className="jcf-select jcf-unselectable jcf-select-min-height"><span
                                            className="jcf-select-text"><span className="">Year</span></span><span
                                            className="jcf-select-opener"></span></span>
                                          </div>
                                        </div>
                                      </div>
                                    ...
                                    <div className="field-row">
                                      ...
                                      <div className="field patient-gender">
                                        ...
                                        </select><span className="jcf-select jcf-unselectable"><span
                                        className="jcf-select-text"><span className="">Select Gender</span></span><span
                                        className="jcf-select-opener"></span></span>
                                      </div>
                                    </div>
                                    ...
                                    <div className="field-row">
                                      ...
                                      <div className="field">
                                        <input type="text" className="form-control" placeholder="" id="patient-bmi"
                                               data-required="true" />
                                      </div>
                                    </div>
                                    <div className="field-row">
                                      ...
                                      <div className="field">
                                        <input type="text" id="patient-source5" className="form-control" disabled=""
